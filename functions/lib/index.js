...
async function checkAndIncrementFreeAI(uid, feature) {
...
async function refundAiUsage(uid, featureType, wasPro) {
    try {
...
exports.aiStream = functions.https.onRequest(async (req, res) => {
    ...
    if (!userIsPro) {
        try {
            const requestedFeature = endpoint === "analysis" ? "ai_analysis" : reqData?.type;
