...
export function LifetimeFinal48Email({
  ...
  return (
    <EmailShell
      preview={`Own Pro outright for ${offerPrice} — the lifetime plan comes off sale Thursday night.`}
