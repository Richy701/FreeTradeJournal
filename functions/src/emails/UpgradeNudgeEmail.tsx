...
export function UpgradeNudgeEmail({ firstName }: UpgradeNudgeEmailProps) {
  return (
    <Html lang="en">
      ...
      <Preview>Turn your trades into personalised AI coaching.</Preview>
      <Body style={body}>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={body1}>
              You signed up for FreeTradeJournal to take your trading seriously.
              Pro is where it gets powerful.
            </Text>
            <Text style={body1}>
          ...
          <Section style={content}>
            <Text style={body1}>
              Pro is <strong>$12.99/month</strong> — or $99.99/year. Cancel anytime. Your free data stays exactly as it is.
            </Text>
