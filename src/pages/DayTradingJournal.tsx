      ...
      <div className="min-h-screen bg-background flex flex-col">
        ...
        <Footer7
          ...
          sections={[
            ...
            { title: "Trading Tools", links: [{ name: "Forex Trading Journal", href: "/forex-trading-journal" }, { name: "Futures Trading Tracker", href: "/futures-trading-tracker" }, { name: "Prop Firm Dashboard", href: "/prop-firm-dashboard" }, { name: "Day Trading Journal", href: "/day-trading-journal" }, { name: "Prop Firm ROI Tracker", href: "/prop-tracker" }] },
