        ...
        <section className="py-24">
            <div className="mx-auto max-w-7xl space-y-16 px-6">
                ...
                <div className="relative mx-auto grid grid-cols-2 gap-6 lg:gap-8 lg:grid-cols-4">
                    <div className="space-y-4 p-6 rounded-xl border border-transparent hover:bg-muted/80 hover:shadow-md transition-all duration-200 min-h-[140px] flex flex-col">
