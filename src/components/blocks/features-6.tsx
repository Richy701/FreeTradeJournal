        ...
        <section className="py-16 md:py-24">
            <div className="mx-auto max-w-6xl space-y-16 px-6">
                <div className="relative z-10 grid items-center gap-6 md:grid-cols-2 md:gap-16">
                    <h2 className="text-4xl lg:text-5xl font-bold leading-tight">Professional forex & futures analytics</h2>
                    <p className="text-lg lg:text-xl text-gray-300 leading-relaxed max-w-lg sm:ml-auto">Monitor real-time P&L, win rates, profit factors, and equity curves. Track trades across multiple markets with automatic calculations and interactive visualizations.</p>
                </div>
                ...
                <div className="relative mx-auto grid grid-cols-2 gap-6 lg:gap-8 lg:grid-cols-4">
                    ...
                    <div className="space-y-4 p-6 rounded-xl hover:bg-gray-800/50 transition-colors duration-150 min-h-[140px] flex flex-col">
                        <div className="flex items-center gap-3">
                            ...
                            <h3 className="text-base font-semibold">Trade Journal</h3>
                        </div>
                        <p className="text-gray-400 text-sm leading-relaxed font-medium flex-1">Comprehensive trade logging with notes, strategies, and tags for performance analysis.</p>
                    </div>
                    <div className="space-y-4 p-6 rounded-xl hover:bg-gray-800/50 transition-colors duration-150 min-h-[140px] flex flex-col">
                        <div className="flex items-center gap-3">
